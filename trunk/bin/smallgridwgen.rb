...
print "We generate a small grid workload: Consists of \n"
print "20 single-node machines, 5 16-node machines and \n"
print "3 32-node machines.\n"
print "#{numTotalSystems} total machines.\n"
